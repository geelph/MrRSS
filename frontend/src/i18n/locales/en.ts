...
const en: TranslationMessages = {
  ...
  noUnreadArticles: 'No unread articles to mark',
  ...
  customTranslation: 'Custom API',
  customTranslationInfo: 'Configure a custom HTTP translation API endpoint',
  customTranslationTemplate: 'Preset Templates',
  customTranslationTemplateDesc: 'Load preset configuration for common services',
  selectTemplate: 'Select Template',
  customTranslationEndpoint: 'API Endpoint',
  customTranslationEndpointDesc: 'The API endpoint URL for the translation service',
  customTranslationEndpointPlaceholder: 'https://api.example.com/translate',
  customTranslationEndpointRequired: 'API endpoint is required',
  customTranslationMethod: 'HTTP Method',
  customTranslationHeaders: 'HTTP Headers',
  customTranslationHeadersDesc: 'Custom HTTP headers',
  headerName: 'Header name',
  headerValue: 'Value',
  customTranslationBodyTemplate: 'Request Body Template',
  customTranslationBodyTemplateDesc: 'Use placeholders in your request body',
  customTranslationBodyTemplatePlaceholder: 'Request body template',
  customTranslationResponsePath: 'Response Path',
  customTranslationResponsePathDesc: 'JSONPath to extract translation (e.g., data.translatedText)',
  customTranslationResponsePathPlaceholder: 'data',
  customTranslationLangMapping: 'Language Code Mapping',
  customTranslationLangMappingDesc: 'Map MrRSS language codes to API-specific codes',
  mrssLangCode: 'en, zh, ...',
  apiLangCode: 'API code',
  customTranslationTimeout: 'Timeout',
  customTranslationTimeoutDesc: 'Request timeout in seconds',
  testCustomTranslation: 'Test Configuration',
  testCustomTranslationDesc: 'Send a test request to verify your configuration',
  ...
  zoomIn: 'Zoom In',
  zoomOut: 'Zoom Out',
  expandContent: 'Show Article Content',
  collapseContent: 'Hide Article Content',
