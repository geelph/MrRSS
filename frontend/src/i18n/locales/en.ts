...
const en: TranslationMessages = {
  ...
  rsshubDescription: 'Use RSSHub for custom RSS routes',
  rsshubEndpoint: 'RSSHub Endpoint',
  rsshubEndpointDesc: 'Your RSSHub server address',
  rsshubAPIKey: 'API Key (optional)',
  ...
  invalidRSSHubRoute: 'Invalid RSSHub route',
  rsshubRouteHint: 'Enter route (e.g., weibo/user/123456)',
  rsshubUsageTitle: 'Using RSSHub routes',
  rsshubUsageFormat1: 'Supports standard RSS URLs',
  rsshubUsageFormat2: 'Also supports RSSHub routes (e.g., nytimes or weibo/user/123456)',
  rsshubRouteActive: 'RSSHub route detected',
  rsshubDocs: 'View all routes →',
