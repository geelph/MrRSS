...
const en: TranslationMessages = {
  ...
  aiChatEnabledDesc: 'Enable AI chat feature for article discussions (consumes tokens)',
  ...
  aiConfigTestDesc: 'Test if your AI settings are configured correctly and working',
  ...
  obsidianVaultNameDesc: 'Name of your Obsidian vault',
