...
const en: TranslationMessages = {
  ...
  // Label Settings
  labels: 'Labels',
  enableLabel: 'Enable Auto-Labeling',
  enableLabelDesc: 'Automatically generate labels for articles',
  labelProvider: 'Label Provider',
  labelProviderDesc: 'Choose label generation method',
  labelAiApiKey: 'AI API Key',
  labelAiApiKeyDesc: 'API key for AI-based label generation',
  labelAiApiKeyPlaceholder: 'sk-...',
  labelAiEndpoint: 'AI Endpoint',
  labelAiEndpointDesc: 'API endpoint URL (leave empty for OpenAI default)',
  labelAiEndpointPlaceholder: 'https://api.openai.com/v1',
  labelAiModel: 'Model Name',
  labelAiModelDesc: 'AI model to use for label generation',
  labelAiModelPlaceholder: 'gpt-4o-mini',
  labelAiSystemPrompt: 'Custom System Prompt',
  labelAiSystemPromptDesc: 'Custom system prompt for AI label generation',
  labelAiSystemPromptPlaceholder:
    'Default: You are a labeling assistant. Generate concise, relevant labels for the given text.',
  labelShowInList: 'Show Labels in Article List',
  labelShowInListDesc: 'Display labels when viewing article lists',
  labelMaxCount: 'Maximum Labels',
  labelMaxCountDesc: 'Maximum number of labels to generate per article',
  generatingLabels: 'Generating labels...',
  generateLabels: 'Generate Labels',
  noLabelsAvailable: 'No labels available',
  editLabels: 'Edit Labels',
  addLabel: 'Add Label',
  labelTooShort: 'Article is too short to generate labels',
