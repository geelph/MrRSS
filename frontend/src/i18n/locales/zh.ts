...
const zh: TranslationMessages = {
  ...
  translationOnlyModeDesc: '仅显示翻译后的文本，隐藏原始内容',
  english: 'English',
  ...
  globalScale: '全局缩放',
  globalScaleDesc: '调整整体界面缩放比例 (50%-200%)',
  ...
  customTranslation: '自定义 API',
  customTranslationInfo: '配置自定义 HTTP 翻译 API 端点',
  customTranslationTemplate: '预设模板',
  customTranslationTemplateDesc: '加载常见服务的预设配置',
  selectTemplate: '选择模板',
  customTranslationEndpoint: 'API 端点',
  customTranslationEndpointDesc: '翻译服务的 API 端点 URL',
  customTranslationEndpointPlaceholder: 'https://api.example.com/translate',
  customTranslationEndpointRequired: 'API 端点是必需的',
  customTranslationMethod: 'HTTP 方法',
  customTranslationHeaders: 'HTTP 请求头',
  customTranslationHeadersDesc: '自定义 HTTP 请求头',
  headerName: '请求头名称',
  headerValue: '值',
  customTranslationBodyTemplate: '请求体模板',
  customTranslationBodyTemplateDesc: '在请求体中使用占位符',
  customTranslationBodyTemplatePlaceholder: '请求体模板',
  customTranslationResponsePath: '响应路径',
  customTranslationResponsePathDesc: 'JSONPath 用于提取翻译结果（例如：data.translatedText）',
  customTranslationResponsePathPlaceholder: 'data',
  customTranslationLangMapping: '语言代码映射',
  customTranslationLangMappingDesc: '将 MrRSS 语言代码映射为 API 特定代码',
  mrssLangCode: 'en、zh 等',
  apiLangCode: 'API 代码',
  customTranslationTimeout: '超时时间',
  customTranslationTimeoutDesc: '以秒为单位的请求超时时间',
  testCustomTranslation: '测试配置',
  testCustomTranslationDesc: '发送测试请求以验证您的配置',
  testSuccess: '测试成功',
  testFailed: '测试失败',
  uncategorized: '未分类',
  unhideArticle: '取消隐藏',
  ...
  zoomIn: '放大',
  zoomOut: '缩小',
  expandContent: '显示文章内容',
  collapseContent: '隐藏文章内容',
