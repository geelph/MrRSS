...
const zh: TranslationMessages = {
  ...
  modal: {
    ...
    discovery: {
      ...
      discoveredFeeds: '已发现 {count} 个订阅源',
      discoverFeeds: '发现订阅源',
      discovering: '发现订阅源中...',
    ...
    feed: {
      ...
      rssUrl: 'RSS 链接',
      rssUrlDescription: '订阅 RSS/Atom 源',
      sourceUrl: '来源链接',
      ...
      typeCustomScriptDescription: '使用自定义脚本处理非标准订阅源',
      typeEmail: '邮件订阅',
      ...
      someFeedsFailedToSubscribe: '部分订阅源订阅失败',
    },
    filter: {
      addCondition: '添加条件',
      and: '且',
