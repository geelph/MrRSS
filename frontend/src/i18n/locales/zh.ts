...
const zh: TranslationMessages = {
  ...
  rsshubDescription: '使用 RSSHub 获取自定义 RSS 源',
  rsshubEndpoint: 'RSSHub 端点',
  rsshubEndpointDesc: '您的 RSSHub 服务器地址',
  rsshubAPIKey: 'API 密钥（可选）',
  ...
  rsshubTesting: '测试中...',
  invalidRSSHubRoute: '无效的 RSSHub 路由',
  rsshubRouteHint: '输入路由（例如：weibo/user/123456）',
  rsshubUsageTitle: '使用 RSSHub 路由',
  rsshubUsageFormat1: '支持标准 RSS URL',
  rsshubUsageFormat2: '也可使用 RSSHub 路由（例如：nytimes 或 weibo/user/123456）',
  rsshubRouteActive: '已检测到 RSSHub 路由',
  rsshubDocs: '查看完整路由列表 →',
  rsshubOptional: '可选',
  fromFeed: '来自订阅源',
  general: '常规',
