...
const zh: TranslationMessages = {
  ...
  labels: '标签',
  enableLabel: '启用自动标签',
  enableLabelDesc: '自动为文章生成标签',
  labelProvider: '标签提供者',
  labelProviderDesc: '选择标签生成方式',
  labelAiApiKey: 'AI API 密钥',
  labelAiApiKeyDesc: '用于 AI 生成标签的 API 密钥',
  labelAiApiKeyPlaceholder: 'sk-...',
  labelAiEndpoint: 'AI 端点',
  labelAiEndpointDesc: 'API 端点 URL（留空使用 OpenAI 默认值）',
  labelAiEndpointPlaceholder: 'https://api.openai.com/v1',
  labelAiModel: '模型名称',
  labelAiModelDesc: '用于标签生成的 AI 模型',
  labelAiModelPlaceholder: 'gpt-4o-mini',
  labelAiSystemPrompt: '自定义系统提示词',
  labelAiSystemPromptDesc: 'AI 标签生成的自定义系统提示词',
  labelAiSystemPromptPlaceholder: '默认：你是一个标签助手。为给定文本生成简洁、相关的标签。',
  labelShowInList: '在文章列表中显示标签',
  labelShowInListDesc: '查看文章列表时显示标签',
  labelMaxCount: '最大标签数',
  labelMaxCountDesc: '每篇文章生成的最大标签数',
  generatingLabels: '正在生成标签...',
  generateLabels: '生成标签',
  noLabelsAvailable: '无可用标签',
  editLabels: '编辑标签',
  addLabel: '添加标签',
  labelTooShort: '文章太短，无法生成标签',
